...
#     BigDecimal.new
#       .should eq(BigDecimal.new(Bigger::Int.new(0)))

#     BigDecimal.new("41.0123")
#       .should eq(BigDecimal.new(Bigger::Int.new(410123), 4))

#     BigDecimal.new(1)
#       .should eq(BigDecimal.new(Bigger::Int.new(1)))
...
#       .should eq(BigDecimal.new(Bigger::Int.new(420123), 4))

#     BigDecimal.new("42_42_42_24.0123_456_789")
#       .should eq(BigDecimal.new(Bigger::Int.new(424242240123456789), 10))

#     BigDecimal.new("0.0")
#       .should eq(BigDecimal.new(Bigger::Int.new(0)))

#     BigDecimal.new(".2")
#       .should eq(BigDecimal.new(Bigger::Int.new(2), 1))

#     BigDecimal.new("2.")
#       .should eq(BigDecimal.new(Bigger::Int.new(2)))
...
#     BigDecimal.new("-0.1")
#       .should eq(BigDecimal.new(Bigger::Int.new(-1), 1))

#     BigDecimal.new("-1.1")
#       .should eq(BigDecimal.new(Bigger::Int.new(-11), 1))
...
#       .should eq(BigDecimal.new(Bigger::Int.new("1238712938791237908742309847029384709172389712983791273901827398127398172390871239182730981029387192083710928371092837019283701982370918237".to_big_i), 49))

#     BigDecimal.new("-123871293879123790874230984702938470917238971298379127390182739812739817239087123918273098.1029387192083710928371092837019283701982370918237")
#       .should eq(BigDecimal.new(Bigger::Int.new("-1238712938791237908742309847029384709172389712983791273901827398127398172390871239182730981029387192083710928371092837019283701982370918237".to_big_i), 49))

#     BigDecimal.new("-0.1029387192083710928371092837019283701982370918237")
#       .should eq(BigDecimal.new(Bigger::Int.new("-1029387192083710928371092837019283701982370918237".to_big_i), 49))
...
#       .should eq(BigDecimal.new(Bigger::Int.new(5), 1))
#   end
...
#     "+1.5".to_big_d.should eq(BigDecimal.new(15, 1))
#     Bigger::Int.new(15).to_big_d.should eq(BigDecimal.new(15, 0))
#     1.5.to_big_d.should eq(BigDecimal.new(15, 1))
...
#     positive_ten = Bigger::Int.new(10)
#     negative_ten = Bigger::Int.new(-10)

# TODO: uncomment after all others have been implemented
...
# private BIG_NUMBER_TYPES = [Bigger::Int, BigFloat, BigDecimal, BigRational]
...
#   division_between_returns {{BUILTIN_NUMBER_TYPES}}, [Bigger::Int, BigFloat], BigFloat
#   division_between_returns [Bigger::Int, BigFloat], {{BUILTIN_NUMBER_TYPES}}, BigFloat
#   division_between_returns [Bigger::Int, BigFloat], [Bigger::Int, BigFloat], BigFloat
...
#   division_between_returns [BigDecimal], [Bigger::Int, BigFloat, BigDecimal], BigDecimal
#   division_between_returns [Bigger::Int, BigFloat, BigDecimal], [BigDecimal], BigDecimal

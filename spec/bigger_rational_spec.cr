...
#   it "initialize" do
#     BigRational.new(Bigger::Int.new(10), Bigger::Int.new(3))
#       .should eq(BigRational.new(10, 3))

#     expect_raises(DivisionByZeroError) do
#       BigRational.new(Bigger::Int.new(2), Bigger::Int.new(0))
#     end
...
#   it "#numerator" do
#     br(10, 3).numerator.should eq(Bigger::Int.new(10))
#   end

#   it "#denominator" do
#     br(10, 3).denominator.should eq(Bigger::Int.new(3))
#   end
...
#   it "#<=>(:Bigger::Int) and Comparable" do
#     test_comp(br(10, 2), Bigger::Int.new(4), Bigger::Int.new(5), Bigger::Int.new(6))
#   end
...
#   it "sqrt" do
#     Math.sqrt(BigRational.new(Bigger::Int.new("1" + "0"*48), 1)).should eq(BigFloat.new("1" + "0"*24))
#   end
# end
